...
function displaySymbol($symbol){
    ...
    echo "<img src='../challenges/challenge1/img/$symbol.png' width='100' height='60'/>";
    
}

$symbols = array("fall", "spring", "summer");  //initializes array with 3 items
...
$symbols[] = "season";  //Adding new element at the end
//displaySymbol(  $symbols[3] );

array_push($symbols, "time");
