...
--
-- Host: localhost
-- Generation Time: Oct 05, 2017 at 09:29 PM
...
--
-- Table structure for table `q_author`
--
...
--
-- Dumping data for table `q_author`
--
...
--
-- Table structure for table `q_cat_quote`
--
...
--
-- Dumping data for table `q_cat_quote`
--
...
--
-- Table structure for table `q_quote`
--
...
--
-- Dumping data for table `q_quote`
--
...
--
ALTER TABLE `q_author`
  MODIFY `authorId` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
